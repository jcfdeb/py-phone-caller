...
FACEBOOK_MMS_NUM2WORDS_LANGUAGE_CODE = conf.get_facebook_mms_num2words_language_code()
...
def text_to_speech_facebook_mms(text, lang_code, output_path):
    ...
    model_paths = {
        f"{FACEBOOK_MMS_LANGUAGE_CODE}": f"pre_trained_models/facebook/mms-tts-{FACEBOOK_MMS_LANGUAGE_CODE}",
    }
...
def create_audio_through_facebook_mms(model_path, text, output_path):
    ...
    # Move waveform to CPU if it was on GPU
